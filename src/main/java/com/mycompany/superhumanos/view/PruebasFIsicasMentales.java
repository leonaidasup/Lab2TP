 ...
 */
public class PruebasFIsicasMentales extends javax.swing.JFrame {

    /**
     * Creates new form PruebasFIsicas
     */
    public PruebasFIsicasMentales() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Vision laser");

        jLabel4.setText("Vision rayos X");

        jLabel5.setText("Salud mental");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PruebasFIsicasMentales.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PruebasFIsicasMentales().setVisible(true);
            }
        });
    }
